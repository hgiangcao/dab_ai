...
EVAL_GAMES_VS_BOTS = project_config.EVAL_GAMES_VS_BOTS
EVAL_GAMES_VS_CURRENT = project_config.EVAL_GAMES_VS_CURRENT
PROMOTION_BOT_SCORE_RATIO = project_config.PROMOTION_BOT_SCORE_RATIO
BEST_UPDATE_SCORE_RATIO = project_config.BEST_UPDATE_SCORE_RATIO
MIN_WINRATE_VS_CURRENT = project_config.MIN_WINRATE_VS_CURRENT
...
PHASES_CONFIG = project_config.PHASES_CONFIG
PHASE_ADVANCE_THRESHOLD = project_config.PHASE_ADVANCE_THRESHOLD